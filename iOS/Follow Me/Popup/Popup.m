...
- (void)setOverallKeyboardAppearance:(UIKeyboardAppearance)keyboardAppearance {
    ...
    for (int i = 0; i < [pTextFieldArray count]; i++) {
        FUITextField *textField = pTextFieldArray[i];
...
- (void)setupTextFields {
    ...
    if (pTextFieldPlaceholderArray) {
        ...
        static FUITextField *textField1 = nil;
        static FUITextField *textField2 = nil;
        static FUITextField *textField3 = nil;
        ...
        if ([pTextFieldPlaceholderArray count] == 1) {
            ...
            textField1.font = [UIFont flatFontOfSize:16];
            textField1.backgroundColor = [UIColor clearColor];
            textField1.edgeInsets = UIEdgeInsetsMake(4.0f, 15.0f, 4.0f, 15.0f);
            textField1.textFieldColor = [UIColor whiteColor];
            textField1.borderColor = [UIColor turquoiseColor];
            textField1.borderWidth = 2.0f;
            textField1.cornerRadius = 3.0f;
            ...
            textField2.font = [UIFont flatFontOfSize:16];
            textField2.backgroundColor = [UIColor clearColor];
            textField2.edgeInsets = UIEdgeInsetsMake(4.0f, 15.0f, 4.0f, 15.0f);
            textField2.textFieldColor = [UIColor whiteColor];
            textField2.borderColor = [UIColor turquoiseColor];
            textField2.borderWidth = 2.0f;
            textField2.cornerRadius = 3.0f;
            ...
            textField3.font = [UIFont flatFontOfSize:16];
            textField3.backgroundColor = [UIColor clearColor];
            textField3.edgeInsets = UIEdgeInsetsMake(4.0f, 15.0f, 4.0f, 15.0f);
            textField3.textFieldColor = [UIColor whiteColor];
            textField3.borderColor = [UIColor turquoiseColor];
            textField3.borderWidth = 2.0f;
            textField3.cornerRadius = 3.0f;
...
- (void)setupButtons {
    ...
    if (pCancelTitle) {
        ...
        if (!cancelBtn) {
            cancelBtn = [[FUIButton alloc] init];
            cancelBtn.buttonColor = [UIColor flatRedColor];
            cancelBtn.shadowColor = [UIColor flatRedColorDark];
            cancelBtn.shadowHeight = 3.0f;
            cancelBtn.cornerRadius = 6.0f;
            cancelBtn.titleLabel.font = [UIFont boldFlatFontOfSize:16];
            [cancelBtn setTitleColor:[UIColor cloudsColor] forState:UIControlStateNormal];
            [cancelBtn setTitleColor:[UIColor cloudsColor] forState:UIControlStateHighlighted];
    ...
    if (pSuccessTitle) {
        ...
        if (!successBtn) {
            successBtn = [[FUIButton alloc] init];
            successBtn.buttonColor = [UIColor turquoiseColor];
            successBtn.shadowColor = [UIColor greenSeaColor];
            successBtn.shadowHeight = 3.0f;
            successBtn.cornerRadius = 6.0f;
            successBtn.titleLabel.font = [UIFont boldFlatFontOfSize:16];
            [successBtn setTitleColor:[UIColor cloudsColor] forState:UIControlStateNormal];
            [successBtn setTitleColor:[UIColor cloudsColor] forState:UIControlStateHighlighted];
            ...
            if ([canBeArray containsObject:type]) {
                if ([type isEqualToString:@"PASSWORD"]) {
                    if (counter < 3) {
                        ...
                        FUITextField *field = pTextFieldArray[counter];
...
- (void)setTextFieldTextForTextFields:(NSArray *)textFieldTextArray {
    ...
    for (int i = 0; i < [pTextFieldArray count]; i++) {
        ...
        if (i < 3) {
            FUITextField *field = [pTextFieldArray objectAtIndex:i];
            NSString *textToFill = [textFieldTextArray objectAtIndex:i];
            
            if (field && textToFill) {
                if ([field isKindOfClass:[FUITextField class]]) {
...
- (FUITextField *)textFieldWithPlaceholder:(NSString *)placeholderText numberOfField:(int)num {
    
    FUITextField *textField;
    textField = [[FUITextField alloc] init];
...
- (BOOL)textFieldShouldReturn:(FUITextField *)textField {
    ...
    if ([textField tag] == [pTextFieldPlaceholderArray count]) {
        ...
        FUITextField *fieldAddOne = (FUITextField *)[self viewWithTag:[textField tag]+1];
...
- (BOOL)textFieldShouldBeginEditing:(FUITextField *)textField {
